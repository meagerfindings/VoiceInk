...
class LicenseViewModel: ObservableObject {
    ...
    @Published private(set) var licenseState: LicenseState = .licensed  // Always licensed for development
    ...
    private func loadLicenseState() {
        // Always set to licensed for open source build
        licenseState = .licensed
    }
    
    var canUseApp: Bool {
        // Always allow app usage for open source build
        return true
    }
